      ...
      <div className="listBlogs">
        <div className="card " style={{ width: "30rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={{ fontSize: "1.15rem", fontStyle: "italic" }} >Joe Mcclein</p>
        ...
        <div className="card" style={{ width: "30rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={{ fontSize: "1.15rem", fontStyle: "italic" }}>Pedro Alfonso</p>
            <button onClick={toggleLongText} className="btn btn-info">
              {isLongTextExpanded ? "Show less" : "Show more"}
            </button>
          </div>
        ...
        <div className="card" style={{ width: "30rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={{ fontSize: "1.15rem", fontStyle: "italic" }}>Linda Catalina</p>
            <button onClick={toggleLongText} className="btn btn-info">
              {isLongTextExpanded ? "Show less" : "Show more"}
            </button>
          </div>
        ...
        <div className="card" style={{ width: "30rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={{ fontSize: "1.15rem", fontStyle: "italic" }}>Nawfal Sentissi</p>
            <button onClick={toggleLongText} className="btn btn-info">
              {isLongTextExpanded ? "Show less" : "Show more"}
            </button>
          </div>
        ...
        <div className="card" style={{ width: "30rem" }}>
          ...
          <div className="card-body">
            ...
            <p className="card-text" style={{ fontSize: "1.15rem", fontStyle: "italic" }}>Jessica Parker</p>
            <button onClick={toggleLongText} className="btn btn-info">
              {isLongTextExpanded ? "Show less" : "Show more"}
            </button>
          </div>
